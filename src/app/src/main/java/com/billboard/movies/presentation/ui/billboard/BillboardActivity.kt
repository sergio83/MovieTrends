...
import com.billboard.movies.presentation.ui.billboard.adapter.MoviesAdapter
import com.billboard.movies.presentation.ui.base.BaseActivity
import com.billboard.movies.presentation.utils.NetworkUtils
import com.billboard.movies.presentation.utils.SpinnerDropDownAdapter
...
class BillboardActivity : BaseActivity() {
    ...
    private var mViewAdapter =
        MoviesAdapter(mutableListOf()) { movie, view ->
...
//    }
    ...
    private fun showChangeLanguageAlert() {
        ...
        val builder = AlertDialog.Builder(this)
        builder.setTitle(getString(R.string.setting_language)).setAdapter(adapter) { _, i ->
    ...
    private fun showMovieDetail(movie: Movie, view: View) {
        ...
        val intent =
            MovieDetailActivity.newIntent(this, movie.videoId)
